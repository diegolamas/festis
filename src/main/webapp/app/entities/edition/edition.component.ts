...
export class EditionComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.editionService.query({
            ...
            (res: HttpResponse<Edition[]>) => this.onSuccess(res.body, res.headers),
    ...
    trackId(index: number, item: Edition) {
        return item.id;
    }
    ...
    registerChangeInEditions() {
        this.eventSubscriber = this.eventManager.subscribe('editionListModification', (response) => this.reset());
    }
