package es.festis.atlas.config.audit;

import com.fasterxml.jackson.databind.ObjectMapper;
import es.festis.atlas.domain.AbstractAuditingEntity;
import es.festis.atlas.domain.EntityAuditEvent;
import es.festis.atlas.repository.EntityAuditEventRepository;
