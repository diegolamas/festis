...
import es.festis.atlas.config.Constants;
import es.festis.atlas.FestisApp;
import es.festis.atlas.domain.Authority;
import es.festis.atlas.domain.User;
import es.festis.atlas.repository.AuthorityRepository;
import es.festis.atlas.repository.UserRepository;
import es.festis.atlas.security.AuthoritiesConstants;
import es.festis.atlas.service.MailService;
import es.festis.atlas.service.dto.UserDTO;
import es.festis.atlas.web.rest.errors.ExceptionTranslator;
import es.festis.atlas.web.rest.vm.KeyAndPasswordVM;
import es.festis.atlas.web.rest.vm.ManagedUserVM;
import es.festis.atlas.service.UserService;
