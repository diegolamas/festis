...
import es.festis.atlas.config.audit.AuditEventConverter;
import es.festis.atlas.domain.PersistentAuditEvent;
...
import static es.festis.atlas.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
